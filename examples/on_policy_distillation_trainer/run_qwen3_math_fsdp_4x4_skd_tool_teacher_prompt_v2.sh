...
PROJECT_NAME='verl_skd_qwen3_math_tool_fsdp_leakprobe'
...
EXP_NAME="fsdp/student-Qwen3-1.7B/teacher-Qwen3-32B-FP8/train-nemotron-cascade-rl-math/loss-${DISTILLATION_LOSS_MODE}/pg-${USE_POLICY_GRADIENT}/4x4-b96-skd-tool-teacherprompt-hardleak-chunk${SKD_CHUNK_SIZE}-topk${SKD_VERIFY_TOP_K}-maxchunks${SKD_MAX_CHUNKS}-sglang-sticky-delta-v2"
