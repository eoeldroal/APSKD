...
EXP_NAME="fsdp/student-Qwen3-1.7B/teacher-Qwen3-8B/train-math-lighteval/loss-${DISTILLATION_LOSS_MODE}/pg-${USE_POLICY_GRADIENT}/6x2-b96-skd-tool-chunk${SKD_CHUNK_SIZE}-topk${SKD_VERIFY_TOP_K}-maxchunks${SKD_MAX_CHUNKS}-sglang-sticky-delta-v1"
...
math_train_path="${DATA_ROOT}/math_multiturn_w_tool/train.parquet"
math_test_path="${DATA_ROOT}/math_multiturn_w_tool/test.parquet"
