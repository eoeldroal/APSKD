...
default_base_model_path="$ROOT_DIR/checkpoints/Qwen3-1.7B"
base_model_path="${BASE_MODEL_PATH:-$default_base_model_path}"
model_tag="${MODEL_TAG:-qwen3_1p7b_base_fresh}"

rl_training_steps="${RL_TRAINING_STEPS:-400}"
total_training_steps="$rl_training_steps"

experiment_name="${EXPERIMENT_NAME:-gspo-qwen3-1.7b-s8-nemotron-tool-ctx16k-${model_tag}}"
